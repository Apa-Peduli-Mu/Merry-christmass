function initengahan(){
  ...
  afterComplete: function(){
    pesan7.innerHTML=vketik7 + nama + "😜";fungsi=1;setTimeout(tombol,400);
  },}).go();
  }
  //Pemisah
  ...
  var otoaktipesan=0;
  function toaktipesan(){kalimat.innerHTML=vketik10 + nama + "!! 🥳";kalimat.style="transform:scale(1);font-size:24px;font-family:var(--gaya-font2)";}
