...
! function(e, t) {
    ...
    function u(e, t = !1, n = !1) {
        let r, i = e.querySelector(".ti-cursor"),
    ...
    return function(e, r = {}) {
        let S = async (e, t, n = !1) => {
            ...
            })), n || await G.beforeStep(this), await ((e, t, n) => new Promise((r => {
                n.push(setTimeout((async () => {
                    await e(), r()
                }), t || 0))
            })))(e, t, J), n || await G.afterStep(this)
        }, N = (e, t) => D({
            index: e,
            queueItems: t,
            wait: S,
        ...
        }(G)[e], x = () => (e => m(e) ? n(e.value) : u(e, !0).filter((e => !(e.childNodes.length > 0))))(V), A = (e, t) => (Y.add(e), ((e = {}) => {
            let t = e.delay;
            t && Y.add({
                delay: t
            })
            ...
            if (!I() && ee && V.appendChild(ee), Z) {
                ...
                })(K, V), ee.dataset.tiAnimationId = K;
                let {
                    animation: e
                } = G.cursor, {
                    frames: t,
            ...
            var t, n, r;
            t = e, n = U, r = x(), U = Math.min(Math.max(n + t, 0), r.length), ((e, t, n) => {
                let r = t[n - 1],
                    i = w(".ti-cursor", e);
        ...
        }, this.getQueue = () => Y, this.getOptions = () => G, this.updateOptions = e => B(e), this.getElement = () => V;
        ...
        })(t(G.strings)), G.strings.length && R()
    }
}));